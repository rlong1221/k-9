...
public class AttachmentInfoExtractorTest {
    ...
    public static final boolean TEST_IS_FIRST_CLASS_ATTACHMENT = true;
    ...
    public void extractInfo__fromLocalBodyPart__shouldReturnProvidedValues() throws Exception {
        ...
        when(part.isFirstClassAttachment()).thenReturn(TEST_IS_FIRST_CLASS_ATTACHMENT);
        ...
        assertEquals(TEST_IS_FIRST_CLASS_ATTACHMENT, attachmentViewInfo.firstClassAttachment);
    }
